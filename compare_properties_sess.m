...
for iTPFN = 1:length(TPFN_names)
    ...
    for istat = 1:length(statistics)
        ...
        saveas(gcf, ['images/compare_' stat '_properties_sess_' TPFN '.png'])
    end
end
...
for iTPFN = 1:length(TPFN_names{iTPFN})
    ...
    for istat = 1:length(statistics)
        ...
        saveas(gcf, ['images/groupstats_' stat '_properties_sess_' TPFN '.png'])
    end
end
...
for iTPFN = 1:length(TPFN_names)
    ...
    for istat = 1:length(statistics)
        ...
        saveas(gcf, ['images/groupstats_allthresh_' stat '_properties_sess_' TPFN '.png'])
    end
end
